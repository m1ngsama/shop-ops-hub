    ...
    public function run(): void
    {
        ...
        $products = collect([
            Product::query()->create([
                ...
                'category' => '个护',
                'status' => 'active',
                'marketplace_focus' => '日常护理必备',
                'cost_price' => 6.40,
                'target_price' => 18.99,
                'fulfillment_fee' => 4.15,
                'safety_stock' => 140,
                'lead_time_days' => 18,
                'selling_points' => '柔顺修护、易于坚持使用，适合放进日常护理清单。',
            ]),
            Product::query()->create([
                ...
                'category' => '家居',
                'status' => 'active',
                'marketplace_focus' => '居家香氛精选',
                'cost_price' => 12.80,
                'target_price' => 34.50,
                'fulfillment_fee' => 7.10,
                'safety_stock' => 90,
                'lead_time_days' => 24,
                'selling_points' => '造型简洁，适合卧室、书房和礼赠场景。',
            ]),
            Product::query()->create([
                ...
                'category' => '服饰',
                'status' => 'active',
                'marketplace_focus' => '轻运动穿搭',
                'cost_price' => 9.20,
                'target_price' => 28.90,
                'fulfillment_fee' => 5.30,
                'safety_stock' => 120,
                'lead_time_days' => 15,
                'selling_points' => '高弹舒适，适合日常训练和轻户外穿着。',
            ]),
            Product::query()->create([
                'supplier_id' => $suppliers['宁波供应组B']->id,
                'sku' => 'TRIP-4107',
                ...
                'category' => '出行',
                'status' => 'active',
                'marketplace_focus' => '旅行收纳必备',
                'cost_price' => 7.50,
                'target_price' => 22.40,
                'fulfillment_fee' => 4.80,
                'safety_stock' => 160,
                'lead_time_days' => 20,
                'selling_points' => '轻便耐用，适合旅行整理和日常收纳。',
            ]),
            Product::query()->create([
                'supplier_id' => $suppliers['华南工厂A']->id,
                'sku' => 'DESK-5202',
                ...
                'category' => '收纳',
                'status' => 'active',
                'marketplace_focus' => '桌面整理好物',
                'cost_price' => 5.90,
                'target_price' => 19.60,
                'fulfillment_fee' => 4.05,
                'safety_stock' => 110,
                'lead_time_days' => 16,
                'selling_points' => '小巧利落，适合整理首饰、手表和随身小物。',
            ]),
        ])->keyBy('sku');
